...
class Amazon_Review(Dataset):
    """`Amazon Review Dataset <https://dl.acm.org/doi/10.1145/2507157.2507163> <https://arxiv.org/abs/2208.07204>`

    The Amazon Review dataset is a sentiment ordinal regression dataset, where the goal
    is to predict the rating of a customer based on their comment. The labels are divided
    into 5 classes (scores ranging from 0 to 4). Originally, each class contains 600,000
    training samples and 130,000 test samples.

    This version uses a processed Amazon Review dataset provided by USB
    (https://github.com/microsoft/semi-supervised-learning). It contains:
        ...
        - The original test dataset remains unchanged (650,000 samples total)
    ...
    _URL = "https://huggingface.co/datasets/py97/Amazon-Review/resolve/main/AmazonReview.tar.gz"
    _MD5 = "080761d785bd86ed6ebcd8e388e401e3"
    ...
    def __init__(
        ...
        self._text_folder = self._base_folder / "AmazonReview"
